...
const staticPaths = [
  ...
  { path: "/services/gastrobar", priority: "0.7", changeFreq: "monthly" },
  { path: "/services/spa",       priority: "0.7", changeFreq: "monthly" },
  { path: "/services/meetings",  priority: "0.7", changeFreq: "monthly" },
